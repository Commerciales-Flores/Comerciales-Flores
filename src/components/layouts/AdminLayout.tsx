            ...
            <div className="hidden lg:flex items-center gap-6">
              <div className="flex items-center gap-4 pr-6 border-r border-blue-800">
                <span className="text-sm font-medium text-blue-100">
                  Welcome, <span className="text-white font-semibold">{(user?.firstName && user.lastName) ? `${user.firstName} ${user.lastName}` : "User"}</span>
                </span>
              ...
              >
                ...
                {/* Dark Admin Header - Matches Admin Header Color */}
                  <div className="p-6 bg-blue-900 text-white relative">
                    ...
                    <div>
                      <h2 className="font-bold text-white text-lg leading-tight">{(user?.firstName && user.lastName) ? `${user.firstName} ${user.lastName}` : "User"}</h2>
