...
import { sanitizeAddressInput } from '../../utils/DataNormalization';
import {
  MapContainer,
  Marker,
  Popup,
...
export default function AddressPicker({
  ...
  const trimmed = sanitizeAddressInput(query).trim();
  setQuery(trimmed);
...
>
  ...
  dragend: async (e) => {
    ...
    const success = await reverseGeocode(next.lat, next.lng);
